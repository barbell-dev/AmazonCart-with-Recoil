...
import "./WishList.css";
function Popup({ item, showPopup, setShowPopup }) {
  let element = document.getElementById("super-card");
  element.classList.add("blurred");
  return (
    <div>
      Item {item} added to cart.<br></br>
      <button
        onClick={() => {
              ...
              >
                ...
                <button
                  onClick={() => {
                    ...
                    let temp_cartItem = [...cartItems, temp];
                    setCartItems((val) => temp_cartItem);
                    // console.log(cartItems);
                    // console.log(temp_cartItem);
                    setShowPopup((val) => [true, element.name]);
                  }}
                >
                  Add to cart
                </button>
